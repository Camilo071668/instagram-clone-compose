package com.juancaballero.instagramclone.data

import com.juancaballero.instagramclone.model.Post
import com.juancaballero.instagramclone.model.Story
...
object DataSource {
    ...
    fun getPosts(): List<Post> = listOf(
        ...
        Post(
            ...
            likes = 988,
            caption = "LazyRow para carruseles horizontales 🎠"
        ),
        Post(
            id = 9,
            username = "kotlin_bogota",
            profileImageUrl = "https://picsum.photos/seed/user9/200/200",
            imageUrl = "https://picsum.photos/seed/post9/800/800",
            likes = 312,
            caption = "State hoisting es clave en Compose 🔑"
        ),
        Post(
            id = 10,
            username = "android_co",
            ...
            likes = 5_670,
            caption = "¡Primer app en Compose completada! 🎉"
        )
    )
    ...
    fun getStories(): List<Story> = listOf(
        ...
        Story(6, "mobile_labs", "https://picsum.photos/seed/s6/200/200", hasSeen = true),
        Story(7, "dev_col", "https://picsum.photos/seed/s7/200/200")
    )
}